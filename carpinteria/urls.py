...
from .views import home, healthz, categoria, producto_detalle, carrito, checkout, pedido_confirmacion, descargar_ticket_pdf, register, logout_view, simulate_pago, admin_panel, cotizacion, RoleBasedLoginView
